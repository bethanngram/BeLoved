...
export default function NetworkClient(){
 ...
 async function respond(req:Request,status:'accepted'|'declined'){
  ...
  setBusy(null)
  if(!error && !message)setMessage(status==='accepted'?'Connection accepted.':'Connection declined.')
  await load()
 }
