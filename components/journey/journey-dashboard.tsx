...
const fields = [
  ...
  ['People', 'Love, tell the truth, forgive, serve, and strengthen.'],
  ['Formation', 'Learn, practice, reflect, integrate, and give.'],
  ['Work', 'Develop capability, carry responsibility, prepare successors.'],
  ['Money', 'Provide, steward, give, and build productive capacity.'],
  ['World', 'Notice need, recognize capacity, contribute where gifts can take root.'],
